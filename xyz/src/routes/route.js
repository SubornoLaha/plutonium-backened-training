...
router.get('/movies/:indexNumber',function(){
    let movies=['Rang de basanti', 'The shining', 'Lord of the rings', 'Batman begins']
    let rqstparams=req.params
    let movieName=rqstParams.indexNumber
    let r=movies[movieName]
    if(movieName<0 || movieName>movies.lenght){
